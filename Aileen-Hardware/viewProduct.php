...
<body>
    ...
    <div class="container my-4" id="cont">
        <div class="row jumbotron">
            ...
            $productImage = base64_encode($row['image']); // Encode the image data for display
            ?>
            <script>
        ...
        <img src="data:image/jpeg;base64,' . $productImage . '" width="249px" height="262px" alt="Product Image">
    </div>
