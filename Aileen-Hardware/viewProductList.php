    ...
    <div class="container my-3" id="cont">
        ...
        <div class="row">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $productImage = base64_encode($row['image']); // Fetch and encode the image

                echo '<div class="col-xs-3 col-sm-3 col-md-3">
            <div class="card" style="width: 18rem;">
                <img src="data:image/jpeg;base64,' . $productImage . '" class="card-img-top" alt="Product Image" width="249px" height="270px">
                <div class="card-body">
