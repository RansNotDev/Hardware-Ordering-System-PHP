  ...
  <div class="container my-3 mb-5">
    ...
    <div class="row">
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        $catImage = base64_encode($row['image']); // Assuming the image is stored in the `image` column

        echo '<div class="col-xs-3 col-sm-3 col-md-3">
              <div class="card" style="width: 18rem;">
                <img src="data:image/jpeg;base64,' . $catImage . '" class="card-img-top" alt="image for this category" width="249px" height="270px">
                <div class="card-body">
