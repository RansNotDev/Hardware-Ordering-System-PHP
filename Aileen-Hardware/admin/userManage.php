    ...
    <div class="row">
        <div class="card col-lg-12">
            <div class="card-body">
                ...
                <td>' . $Id . '</td>
                <td>
                    <img src="data:image/jpeg;base64,' . $imageData . '" alt="User Image" onError="this.src =\'/Aileen-Hardware/Aileen-Hardware/img/profilePic.jpg\'" width="100px" height="100px">
                </td>
                <td>' . $username . '</td>
                <td>
...
while ($userRow = mysqli_fetch_assoc($userResult)) {
    ...
    $imageData = base64_encode($userRow['image']); // Encode image as base64
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(111, 202, 203);">
                    <h5 class="modal-title">User Id: <b><?php echo $Id; ?></b></h5>
                ...
                <div class="modal-body">
                    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                        ...
                        <div class="form-group col-md-4">
                            <img src="data:image/jpeg;base64,<?php echo $imageData; ?>" alt="Profile Photo" width="100" height="100" onError="this.src ='/Aileen-Hardware/Aileen-Hardware/img/profilePic.jpg'">
